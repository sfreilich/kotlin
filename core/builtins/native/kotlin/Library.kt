 ...
 */
public actual fun <reified @PureReifiable T> arrayOfNulls(size: Int): Array<T?>

/**
 * Returns an array containing the specified elements.
 */
public actual inline fun <reified @PureReifiable T> arrayOf(vararg elements: T): Array<T>
