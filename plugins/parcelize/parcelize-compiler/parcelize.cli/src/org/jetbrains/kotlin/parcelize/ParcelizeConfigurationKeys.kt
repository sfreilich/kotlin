...
object ParcelizeConfigurationKeys {
    ...
    val IGNORED_ON_PARCEL_ALIAS: CompilerConfigurationKey<List<String>> =
        CompilerConfigurationKey.create(ParcelizeCommandLineProcessor.IGNORED_ON_PARCEL_ALIAS_OPTION.description)
}