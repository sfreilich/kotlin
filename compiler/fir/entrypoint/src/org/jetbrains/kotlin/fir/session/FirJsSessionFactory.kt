        ...
        return createModuleBasedSession(
            ...
            createProviders = { session, kotlinScopeProvider, symbolProvider, generatedSymbolsProvider, dependencies ->
                listOfNotNull(
                    ...
                    // Check dependencies to make sure there is a single `FirStdlibBuiltinSyntheticFunctionInterfaceProvider` (if an hmpp project is being compiled)
                    runIf(session.languageVersionSettings.getFlag(AnalysisFlags.stdlibCompilation) &&
                                  moduleData.isCommon &&
                                  dependencies.none { it is FirStdlibBuiltinSyntheticFunctionInterfaceProvider }
                    ) {
