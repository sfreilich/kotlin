...
object FirJavaClassInheritsKtPrivateClassExprChecker : FirQualifiedAccessExpressionChecker(MppCheckerKind.Common) {
    ...
    override fun check(expression: FirQualifiedAccessExpression, context: CheckerContext, reporter: DiagnosticReporter) {
        ...
        if (expression.calleeReference.toResolvedCallableSymbol()?.fir?.javaClsInheritsKtPrivateCls == true) {
            reporter.reportOn(expression.source, JAVA_CLASS_INHERITS_KT_PRIVATE_CLASS, context)
        }
    }
