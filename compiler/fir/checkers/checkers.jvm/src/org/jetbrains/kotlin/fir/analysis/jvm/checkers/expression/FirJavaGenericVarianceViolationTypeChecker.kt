...
object FirJavaGenericVarianceViolationTypeChecker : FirFunctionCallChecker(MppCheckerKind.Common) {
    ...
    private fun ConeKotlinType.removeOutProjection(isCovariant: Boolean): ConeKotlinType {
        return when (this) {
            ...
            is ConeSimpleOrDefinitelyNotNullType -> removeOutProjection(isCovariant)
        }
    }

    private fun ConeSimpleOrDefinitelyNotNullType.removeOutProjection(isCovariant: Boolean): ConeSimpleOrDefinitelyNotNullType {
        return when (this) {
    ...
    private fun ConeInferenceContext.isTypeConstructorEqualOrSubClassOf(
        ...
        superType: ConeSimpleOrDefinitelyNotNullType,
    ): Boolean {
