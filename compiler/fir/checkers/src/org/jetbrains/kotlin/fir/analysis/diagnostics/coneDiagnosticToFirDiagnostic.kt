...
private fun ConeDiagnostic.toKtDiagnostic(
    ...
    is ConeAmbiguityError -> @OptIn(ApplicabilityDetail::class) when {
        ...
        candidates.all {
            ...
            it.argumentMapping.keys.any(AbstractConeCallAtom::containsErrorTypeForSuppressingAmbiguityError) ||
                    it.contextReceiverArguments?.any(AbstractConeCallAtom::containsErrorTypeForSuppressingAmbiguityError) == true ||
...
private fun AbstractConeCallAtom.containsErrorTypeForSuppressingAmbiguityError(): Boolean {
    val arg = expression
