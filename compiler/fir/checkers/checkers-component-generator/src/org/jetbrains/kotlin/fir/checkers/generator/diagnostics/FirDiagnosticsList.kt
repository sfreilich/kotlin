...
object DIAGNOSTICS_LIST : DiagnosticList("FirErrors") {
    ...
    val SUPERTYPES by object : DiagnosticGroup("Supertypes") {
        ...
        val CLASS_CANNOT_BE_EXTENDED_DIRECTLY by error<PsiElement> {
            parameter<FirRegularClassSymbol>("classSymbol")
        }
        val SUPERTYPE_IS_EXTENSION_FUNCTION_TYPE by error<PsiElement>()
        val SINGLETON_IN_SUPERTYPE by error<PsiElement>()
        val NULLABLE_SUPERTYPE by error<PsiElement>(PositioningStrategy.QUESTION_MARK_BY_TYPE)
        val MANY_CLASSES_IN_SUPERTYPE_LIST by error<PsiElement>()
        val SUPERTYPE_APPEARS_TWICE by error<PsiElement>()
        ...
        val SEALED_INHERITOR_IN_DIFFERENT_PACKAGE by error<PsiElement>()
        val SEALED_INHERITOR_IN_DIFFERENT_MODULE by error<PsiElement>()
        val CLASS_INHERITS_JAVA_SEALED_CLASS by error<PsiElement>()
    ...
    val CONSTRUCTOR_PROBLEMS by object : DiagnosticGroup("Constructor problems") {
        ...
        val SUPERTYPE_NOT_INITIALIZED by error<PsiElement>()
    ...
    val ANNOTATIONS by object : DiagnosticGroup("Annotations") {
        ...
        val INVALID_TYPE_OF_ANNOTATION_MEMBER by error<PsiElement>()
        ...
        val NULLABLE_TYPE_OF_ANNOTATION_MEMBER by error<PsiElement>()
    ...
    val EXPOSED_VISIBILITY by object : DiagnosticGroup("Exposed visibility") {
        ...
        val EXPOSED_RECEIVER_TYPE by exposedVisibilityError<PsiElement>()
        ...
        val EXPOSED_SUPER_INTERFACE by exposedVisibilityError<PsiElement>()
        val EXPOSED_SUPER_CLASS by exposedVisibilityError<PsiElement>()
        val EXPOSED_TYPE_PARAMETER_BOUND by exposedVisibilityError<PsiElement>()
    }
    ...
    val VALUE_CLASSES by object : DiagnosticGroup("Value classes") {
        ...
        val VALUE_CLASS_HAS_INAPPLICABLE_PARAMETER_TYPE by error<PsiElement> {
            parameter<ConeKotlinType>("type")
        }
        val VALUE_CLASS_CANNOT_IMPLEMENT_INTERFACE_BY_DELEGATION by error<PsiElement>()
        val VALUE_CLASS_CANNOT_EXTEND_CLASSES by error<PsiElement>()
        val VALUE_CLASS_CANNOT_BE_RECURSIVE by error<PsiElement>()
        ...
        val TYPE_ARGUMENT_ON_TYPED_VALUE_CLASS_EQUALS by error<PsiElement>()
    ...
    val TYPES_AND_TYPE_PARAMETERS by object : DiagnosticGroup("Types & type parameters") {
        ...
        val FINAL_UPPER_BOUND by warning<PsiElement> {
            parameter<ConeKotlinType>("type")
        }

        val UPPER_BOUND_IS_EXTENSION_FUNCTION_TYPE by error<PsiElement>()

        val BOUNDS_NOT_ALLOWED_IF_BOUNDED_BY_TYPE_PARAMETER by error<KtElement>()

        val ONLY_ONE_CLASS_BOUND_ALLOWED by error<PsiElement>()

        val REPEATED_BOUND by error<PsiElement>()
        ...
        val BOUND_ON_TYPE_ALIAS_PARAMETER_NOT_ALLOWED by error<PsiElement>()
        ...
        val DYNAMIC_SUPERTYPE by error<PsiElement>()

        val DYNAMIC_UPPER_BOUND by error<PsiElement>()
        ...
        val REDUNDANT_NULLABLE by warning<PsiElement>(PositioningStrategy.REDUNDANT_NULLABLE)
        ...
        val INCORRECT_LEFT_COMPONENT_OF_INTERSECTION by error<PsiElement>()
        val INCORRECT_RIGHT_COMPONENT_OF_INTERSECTION by error<PsiElement>()
        val NULLABLE_ON_DEFINITELY_NOT_NULLABLE by error<PsiElement>()
    }
    ...
    val PROPERTIES_AND_ACCESSORS by object : DiagnosticGroup("Properties & accessors") {
        ...
        val WRONG_SETTER_PARAMETER_TYPE by error<PsiElement> {
            parameter<ConeKotlinType>("expectedType")
            parameter<ConeKotlinType>("actualType")
        }
        ...
        val WRONG_SETTER_RETURN_TYPE by error<PsiElement>()
        val WRONG_GETTER_RETURN_TYPE by error<PsiElement> {
            parameter<ConeKotlinType>("expectedType")
            parameter<ConeKotlinType>("actualType")
        }
    ...
    val CASTS_AND_IS_CHECKS by object : DiagnosticGroup("Casts and is-checks") {
        ...
        val IS_ENUM_ENTRY by error<PsiElement>()
        val DYNAMIC_NOT_ALLOWED by error<PsiElement>()
        val ENUM_ENTRY_AS_TYPE by error<PsiElement>(PositioningStrategy.SELECTOR_BY_QUALIFIED)
    }
    ...
    val EXTENDED_CHECKERS by object : DiagnosticGroup("Extended checkers") {
        ...
        val REDUNDANT_RETURN_UNIT_TYPE by warning<PsiElement>()
