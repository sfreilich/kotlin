...
private fun isSubtypeForSamConversion(
    ...
    val expectedReturnType = classLikeExpectedFunctionType.returnType(session).unwrapFlexibleAndDefinitelyNotNull()
    ...
    return parameterPairs.all { (invokeParameter, expectedParameter) ->
        val expectedParameterType = expectedParameter.unwrapFlexibleAndDefinitelyNotNull()
        // TODO: can we remove is ConeTypeParameterType check here?
