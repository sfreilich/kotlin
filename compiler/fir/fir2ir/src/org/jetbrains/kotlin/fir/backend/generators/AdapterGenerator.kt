...
internal class AdapterGenerator(
    ...
    private fun ConeKotlinType.removeExternalProjections(): ConeKotlinType? =
        when (this) {
            is ConeSimpleOrDefinitelyNotNullType -> removeExternalProjections()
    ...
    private fun ConeSimpleOrDefinitelyNotNullType.removeExternalProjections(): ConeSimpleOrDefinitelyNotNullType? =
