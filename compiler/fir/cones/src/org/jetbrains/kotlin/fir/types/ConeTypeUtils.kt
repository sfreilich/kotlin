...
fun ConeKotlinType.upperBoundIfFlexible(): ConeSimpleOrDefinitelyNotNullType {
    return when (this) {
        is ConeSimpleKotlinType -> this
...
fun ConeKotlinType.lowerBoundIfFlexible(): ConeSimpleOrDefinitelyNotNullType {
    return when (this) {
        is ConeSimpleKotlinType -> this
...
fun ConeSimpleOrDefinitelyNotNullType.getConstructor(): TypeConstructorMarker {
    return when (this) {
