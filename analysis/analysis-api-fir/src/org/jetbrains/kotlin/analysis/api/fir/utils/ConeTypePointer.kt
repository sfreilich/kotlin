...
import org.jetbrains.kotlin.fir.types.ConeSimpleOrDefinitelyNotNullType
...
private abstract class AbstractConeFlexibleTypePointer<T : ConeFlexibleType>(
    ...
    abstract fun restore(lowerBound: ConeSimpleOrDefinitelyNotNullType, upperBound: ConeSimpleOrDefinitelyNotNullType): T
}
...
private class ConeFlexibleTypePointer(
    ...
    override fun restore(lowerBound: ConeSimpleOrDefinitelyNotNullType, upperBound: ConeSimpleOrDefinitelyNotNullType): ConeFlexibleType {
